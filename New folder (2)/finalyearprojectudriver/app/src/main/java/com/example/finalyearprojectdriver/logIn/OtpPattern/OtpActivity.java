package com.example.finalyearprojectdriver.logIn.OtpPattern;
...
import com.example.finalyearprojectdriver.signUp.Sign_up;
...
//        mAuth.addAuthStateListener(authStateListener);
    ...
    public void checkUserProfile() {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("ambulances/"+currentUserId);
...
//        }
    ...
    public void sendUserToHome() {
        Intent homeIntent = new Intent(OtpActivity.this, PermissionActivity.class);
        homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(homeIntent);
        finish();
