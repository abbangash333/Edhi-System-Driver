...
import com.example.finalyearprojectdriver.ambulance.PermissionActivity;
...
public class Sign_up extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //this will be used to choose images from the storage
...
// this will send user to home screen which is Map activity
...
// this method will upload user profile to the firebase
...
//                                    UploadUserInfo imageUploadInfo = new UploadUserInfo(uName,uEmail, downloadUrl.toString());
    ...
    //this will be called after the successfull result of taking picture from the storage
...
// will give the extension of the image selected
...
//when the user pressed back button
    @Override
